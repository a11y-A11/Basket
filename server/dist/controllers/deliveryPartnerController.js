...
export const getMyDeliveryDetail = async (req, res) => {
...
// PUT/ API/ delivery/ my-delivery/ :id/ complete
...
// Cancel delivery
// PUT/ API/ delivery/ my-delivery/ :id/ Cancel
export const cancelDelivery = async (req, res) => {
    ...
    if (order.status === "Delivered") {
        return res.status(400).json({ message: "Can't cancel a delivered order" });
    }
    const history = order.statusHistory;
...
// Update order status
// PUT/ API/ delivery/ my-delivery/ :id/ status
