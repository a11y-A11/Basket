    ...
    <div>
        {bannerVisible && (
            <div className="bg-linear-to-r from-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden">
                <div className="max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 py-2 flex-center gap-6">
                    <div className="flex-center gap-2">
                        <TruckIcon className="size-4 shrink-0"/>
                        <span className="font-medium">Free Delivery on orders above {"\u09F3"} 899</span>
                    </div>
                    <span className="hidden sm:inline text-white/40"></span>
                    <div className="hidden sm:flex items-center gap-2">
                        <ZapIcon className="size3.5 fill-yellow-400 text-yellow-400 shrink-0" />
                        <span>Fresh product delivered daily</span>
                    </div>
                </div>
