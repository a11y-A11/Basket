...
export const dummyAddressData = [
    { label: "Home", address: "123 Main St ", city: "Mirpur ", district: "Dhaka", zip: "1000", isDefault: true, lat: 23.8046, lng: 90.3631, _id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "456 Market St ", city: "Mirpur ", district: "Dhaka", zip: "1000", isDefault: false, lat: 23.8046, lng: 90.3631, _id: "69d3652df9a340288f1a0f8d" },
];
