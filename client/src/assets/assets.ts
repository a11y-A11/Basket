...
export const appPromoBannerData = {
    ...
    description: "Download the Basket~Bounce app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
...
export const footerData = {
    ...
    contact: [
        { icon: MapPinIcon, text: "123 Green Valley Rd, Mirpur" },
        { icon: PhoneIcon, text: "+880 1230-4567" },
        { icon: MailIcon, text: "basket@example.com" },
    ],

    bottom: {
        copyright: "© 2026 Basket~Bounce. All rights reserved.",
        links: [
...
export const dummyDashboardOrdersData = [
    ...
    {
        shippingAddress: { label: "Home", address: "New Market Road ", city: " Mirpur ", district: "Dhaka", zip: "1000", lat: 23.8046, lng: 90.3631 },
        liveLocation: { lat: 23.8046, lng: 90.3631, updatedAt: "2026-04-06T08:41:27.211Z" },
        id: "69d366617ed7e54198d67dad",
...
export const dummyAddressData = [
    { label: "Home", address: "123 Main St ", city: "Mirpur ", district: "Dhaka", zip: "1000", isDefault: true, lat: 23.8046, lng: 90.3631, id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "456 Market St ", city: "Mirpur ", district: "Dhaka", zip: "1000", isDefault: false, lat: 23.8046, lng: 90.3631, id: "69d3652df9a340288f1a0f8d" },
];
