...
const Products = () => {
  ...
  const organic = searchParam.get("organic") || "";
  ...
  const clearFilters = ()=> setSearchParam({})
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <ChevronDown className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-app-text-light pointer-none" />
                </div>
              </div>
            </div>
            ...
            { loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-sm text-app-light mb-4">Try to adjust your filters or search terms</p>
            ...
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt-16">
                {Array.from({length: totalPages}).map((_, i)=>(
                  <button key={i} onClick={()=> {updateFilter("page", String(i+1)); scrollTo(0,0)}} className={`size-9 rounded-lg text-sm font-medium transition-colors ${page === i+1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>{i+1}</button>
                ))}
              </div>
            )}
          </main>
